  ...
  return (
    <>
      ...
      <div className="m-2 p-4">
        ...
        <ul className="text-blue-500 hover:text-blue-800 font-bold p-4 leading-5">
            <li className="mt-2"><a href="/locations/nairobi">Nairobi</a></li>
            <li className="mt-2"><a href="/locations/mombasa">Mombasa</a></li>
            <li className="mt-2"><a href="/locations/eldoret">Eldoret</a></li>
        </ul>
