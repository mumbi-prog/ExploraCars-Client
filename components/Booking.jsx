  ...
  return (
    <div className="w-full h-full p-10">
      ...
      <div className="mb-4 lg:flex lg:justify-end mt-1">
        <button
          className="absolute right-0 px-4 bg-blue-500 text-white rounded-md py-1"
          onClick={handleBookingClick}>
          See bookings
        </button>
      </div>
      <Calendar
        className="w-96 h-64 rounded-md mb-6 bg-blue-300 react-calendar"
        onChange={setTgl}
        value={tgl}
        tileClassName={({ date }) => {
      ...
      />
      <form
        className="mt-5 w-1/2 md:w-3/4 lg:w-1/2 p-5 rounded-xl border-solid"
        ...
        <div className="mb-4">
          ...
          <button
            type="submit"
            className="p-2 rounded-lg mx-4 py-2 mt-3 font-bold px-6 shadow-md border border-blue-500 bg-blue-500 hover:bg-blue-700 ml-0">
            submit
          </button>
        </div>
      </form>
