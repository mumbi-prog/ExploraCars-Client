...
export default function Qualifications() {
  ...
  return (
    <div className="p-2 ">
      ...
      <Accordion variant="shadow"className="py-2">
        <AccordionItem
          key="1"
          aria-label="Driver requirements"
          title="👤 Driver requirements"className="accordion text-left">
        ...
        <AccordionItem key="2" aria-label="💳 Payment Policy" title="💳 Payment Policy"className="accordion">
        ...
        <AccordionItem key="4" aria-label="📄 Rental Conditions " title="📄 Rental Conditions"className="accordion">
          <ul className="requirements-list mx-2">
            <li>✔️ Rate Includes
              <ul>
                <li className="text-xs font-thin">Free cancellation with a full refund up to 48 hours before your pick-up time, Unlimited mileage, Collision Damage Waiver, Roadside Assistance (in the country of pick-up), Third Party Liability and VAT (value added tax).</li>
                </ul> 
                </li>
          </ul>
        </AccordionItem>
