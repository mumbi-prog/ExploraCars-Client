...
export default function Recomendations() {
  return (
    <>
      ...
      <div className="flex flex-col md:flex-row gap-auto mx-2">
        ...
        <div className="flex gap-5 xsm:gap-2 ">
          <Card className="recommendations-card ">
            ...
            <p className="cardheader">4.9</p>
                <p className="flex justify-start items-center gap-1"> <SiTrustpilot/>Trustpilot</p>
            </CardBody>
          </Card>
          <Card className="recommendations-card ">
            <CardBody className="m-auto">
            <p className="cardheader">4.8</p>
                <p className="flex justify-start items-center gap-1"><FcGoogle/>Google</p>
            </CardBody>
          </Card>
          <Card className="recommendations-card ">
            <CardBody className="m-auto">
            <p className="cardheader">4.9</p>
                <p className="flex justify-start items-center gap-1"> <FaFacebookF/>Facebook</p>
            </CardBody>
          </Card>
        </div>
      </div>
