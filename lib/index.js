...
export function registerUser(formData, navigate) {
  ...
  export async function getCar(id) {
    try {
      const response =  axiosInstance.get(`https://explora-cars-production.up.railway.app/cars/${id}`)
...
export async function getCarData(){
  try {
    const response = await fetch("https://explora-cars-production.up.railway.app/cars")
